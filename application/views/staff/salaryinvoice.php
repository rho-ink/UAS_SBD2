    ...
    <section class="invoice" id="invoice">
      ...
      <div class="row invoice-info">
        <div class="col-sm-4 invoice-col">
          select_department_byID
          <address>
            <strong>Kemkominfo</strong><br>
            Ujang<br>
            Cigoong<br>
            Website: www.kemkominfo.com<br>
            Email: Ujang@kominfo.go.id
          </address>
        </div>
        <!-- /.col -->
        <div class="col-sm-4 invoice-col">
      ...
      <div class="row">
        ...
        <div class="col-xs-6">
          ...
          <?php echo $cnt['staff_name']; ?>, Pembayaran seng di proses deposit akan dikirim secara digital pada <?php echo date('d-m-Y', strtotime($cnt['added_on'])); ?>
          </p>
        </div>
        <!-- /.col -->
        <div class="col-xs-6">
          <p class="lead">Info Gaji</p>

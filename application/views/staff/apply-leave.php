        ...
        <div class="col-md-12">
          ...
          <div class="box box-info">
            <div class="box-header with-border">
              <h3 class="box-title">Minta Absen</h3>
            </div>
            <!-- /.box-header -->
            <!-- form start -->
              ...
              <div class="box-body">
                ...
                <div class="col-md-6">
                  <div class="form-group">
                    ...
                    <input type="text" name="txtreason" class="form-control" placeholder="Alasan">
                  </div>
                </div>
                ...
                <div class="col-md-6">
                  <div class="form-group">
                    ...
                    <textarea name="txtdescription" class="form-control" placeholder="Penjelasan"></textarea>
                  </div>
                </div>

                    ...
                    <div class="box-body">
                      ...
                      <div class="col-md-6">
                        <div class="form-group">
                          ...
                          <input type="hidden" name="txtid" value="<?php echo $cnt['id'] ?>" class="form-control" placeholder="Nama Lengkap">
                          <input type="text" name="txtname" value="<?php echo $cnt['staff_name'] ?>" class="form-control" placeholder="Nama Lengkap">
                        </div>
                      </div>
                      ...
                      <div class="col-md-6">
                        <div class="form-group">
                          <label>Mobile</label>
                          <input type="text" name="txtmobile" value="<?php echo $cnt['mobile'] ?>" class="form-control" placeholder="Telepon" readonly>
                        </div>
                      </div>
                      ...
                      <div class="col-md-6">
                        <div class="form-group">
                          <label>City</label>
                          <input type="text" name="txtcity" value="<?php echo $cnt['city'] ?>" class="form-control" placeholder="Kota">
                        </div>
                      </div>
                      ...
                      <div class="col-md-6">
                        <div class="form-group">
                          <label>State</label>
                          <input type="text" name="txtstate" value="<?php echo $cnt['state'] ?>" class="form-control" placeholder="Provinsi">
                        </div>
                      </div>

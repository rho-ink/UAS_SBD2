      ...
      <div class="row">
        ...
        <div class="col-xs-6">
          ...
          <p class="text-muted well well-sm no-shadow" style="margin-top: 10px;">
            <?php echo $cnt['staff_name']; ?>, Pembayaran sedang diproses. Deposit akan dikirim secara digital pada tanggal <?php echo $cnt['added_on']; ?> <br> Regards OMS
          </p>
        </div>
        <!-- /.col -->
        <div class="col-xs-6">

    ...
    <section class="invoice" id="invoice">
      ...
      <div class="row">
        ...
        <div class="col-xs-6">
          ...
          <?php echo $cnt['staff_name']; ?>, Pembayaran sedang diproses. Deposit akan dikirim secara digital pada tanggal <?php echo date('d-m-Y', strtotime($cnt['added_on'])); ?>
          </p>
        </div>
        <!-- /.col -->
        <div class="col-xs-6">
